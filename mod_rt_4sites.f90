...
subroutine main
   ...
   open(101,file="rob_parameter_7.out")
   open(102,file="eigen_energies_7.out")
   open(103,file="H_12_7.out")
   open(104,file="H_23_7.out")
   open(105,file="H_13_7.out")
   open(106,file="lambda_7.out")
   call setup_parameters
   do k=1,10000
     call changing_parameters
     call init_cond
     open(100,file="sigma_7.out")
     do i=1,nsteps
        call write_sigma
        call evolve
     enddo
     robustness_parameter(k)=(nsteps*real(sigma_diab(4,4)))/(p2collapse*p3collapse)
...
subroutine setup_parameters
    ...
    H_diab(2,2)=-100.d0*wave_to_J
    H_diab(3,3)=-269.d0*wave_to_J
    H_diab(4,4)=-469.d0*wave_to_J
    H_diab(1,2)=39.d0*wave_to_J  ;  H_diab(2,1)=H_diab(1,2)
    H_diab(1,3)=-20.d0*wave_to_J    ;  H_diab(3,1)=H_diab(1,3)
    H_diab(1,4)=0.d0*wave_to_J    ;  H_diab(4,1)=H_diab(1,4)
    H_diab(2,3)=45.d0*wave_to_J   ;  H_diab(3,2)=H_diab(3,2)
...
subroutine changing_parameters
    ...
    write(102,*) H_diab(1,1)/wave_to_J,H_diab(2,2)/wave_to_J,H_diab(3,3)/wave_to_J,H_diab(4,4)/wave_to_J,H_diab(1,4)/wave_to_J
     Hamil_e=H_diab
